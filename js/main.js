$(document).ready(function() {
      ...
      //randomiseSnow(snowSpeed);           // Make the snow do random shit    
        ...
        $('#go').click(function(){
            ...
            var text = [ 
            { "greeting": "", "message": "May your days be merry and bright", "signed": "" },
            { "greeting": "", "message": "Christmas isn't just a day. it's a frame of mind", "signed": "KGN" },
            { "greeting": "name,", "message": "Wishing you a holly jolly Christmas", "signed": "From, KGN" },
